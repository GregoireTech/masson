const canvas = (socket) => {
    ...
    function touch_ev(ev) {
      ...
      if (func) {
        if(typeEquiv === 'mouseup' && lastEvent){
      ...
      tools.circle = function () {
        ...
        this.touchstart = function (ev) {
          tool.started = true;
          var rect = canvas.getBoundingClientRect();
          tool.x1 = ev.touches[0].clientX - rect.left;
          tool.y1 = ev.touches[0].clientY - rect.top;
        };
        ...
        this.touchmove = function (ev) {
          ...
          var rect = canvas.getBoundingClientRect();
          tool.x2 = ev.touches[0].clientX - rect.left;
          tool.y2 = ev.touches[0].clientY - rect.top;
